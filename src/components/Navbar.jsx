...
export default function Navbar() {
  ...
  const handleNavClick = (item, e) => {
    if (item.external) {
      e.preventDefault()
      // Open CV PDF in new tab - replace with your actual CV URL
      window.open('/cv-trias-aldi-prasetia.pdf', '_blank')
    }
    setMenuOpen(false)
  }
    ...
    <>
      ...
      >
        <nav className="max-w-7xl mx-auto px-6 md:px-12 h-16 flex items-center justify-between">
          {/* Logo */}
          <NavLink to="/" className="font-display text-lg font-semibold text-cream-50 tracking-tight">
