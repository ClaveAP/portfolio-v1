...
const projects = [
  {
    id: 1,
    title: 'Project Alpha',
    description: 'Aplikasi manajemen data berbasis web yang dirancang untuk meningkatkan efisiensi operasional tim.',
    image: null,
    color: '#1a3a2a',
    accent: '#4f6b49',
  ...
  },
  {
    id: 2,
    title: 'Project Beta',
    description: 'Dashboard analitik interaktif dengan visualisasi data real-time dan laporan otomatis.',
    image: null,
    color: '#2a1a0a',
    accent: '#c8913a',
  ...
  },
  {
    id: 3,
    title: 'Project Gamma',
    description: 'Platform komunitas digital untuk mahasiswa IPB University dengan fitur kolaborasi dan diskusi.',
    image: null,
    color: '#0a1a2a',
    accent: '#3a6b8a',
  ...
  },
  {
    id: 4,
    title: 'Project Delta',
    description: 'Sistem otomatisasi laporan dan analisis data Human Capital untuk organisasi kampus.',
    image: null,
    color: '#1a0a2a',
    accent: '#6a4a8a',
  ...
  },
  {
    ...
    description: 'Aplikasi mobile untuk tracking kegiatan mahasiswa dan manajemen event kampus.',
    image: null,
    color: '#2a1a1a',
    accent: '#8a4a4a',
  ...
  },
  {
    id: 6,
    title: 'Project Zeta',
    description: 'Website portofolio personal dengan animasi 3D dan desain modern untuk presentasi karya.',
    image: null,
    color: '#1a2a1a',
    accent: '#8fa888',
        ...
        {project.image ? (
          ...
          <div className="w-full h-full flex items-center justify-center">
            ...
            <svg width="120" height="120" viewBox="0 0 120 120" className="opacity-20">
              <circle cx="60" cy="60" r="50" fill="none" stroke={project.accent} strokeWidth="1" />
              <circle cx="60" cy="60" r="35" fill="none" stroke={project.accent} strokeWidth="0.5" />
              <circle cx="60" cy="60" r="20" fill="none" stroke={project.accent} strokeWidth="0.5" />
              <line x1="10" y1="60" x2="110" y2="60" stroke={project.accent} strokeWidth="0.5" />
              <line x1="60" y1="10" x2="60" y2="110" stroke={project.accent} strokeWidth="0.5" />
            </svg>
          </div>
        )}
        <motion.div
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="mt-6 font-body text-ink-500 max-w-md leading-relaxed">
              Kumpulan karya dan proyek yang telah saya kerjakan, dari aplikasi web hingga analisis data.
            </p>
          </motion.div>
